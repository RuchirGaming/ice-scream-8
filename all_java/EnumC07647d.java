...
public enum EnumC07647d {
    A09(9000, A00(0, 30, 116)),
    A07(3001, A00(160, 29, 56)),
    A06(3002, A00(125, 35, 6)),
    A08(AuthApiStatusCodes.AUTH_API_SERVER_ERROR, A00(PsExtractor.PRIVATE_STREAM_1, 33, 36)),
    ...
    public static String A00(int i2, int i3, int i4) {
        ...
        while (true) {
            ...
            if (A03[6].charAt(17) != '3') {
                A03[3] = "XBx";
                bArrCopyOfRange[i5] = (byte) ((b2 ^ i4) ^ 105);
                i5++;
            } else {
                A03[3] = "7Eu";
                bArrCopyOfRange[i5] = (byte) ((b2 ^ i4) ^ 105);
