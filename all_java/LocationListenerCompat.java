...
public interface LocationListenerCompat extends LocationListener {
    ...
    public final /* synthetic */ class CC {
        public static void $default$onFlushComplete(LocationListenerCompat _this, int i2) {
        }
        ...
        public static void $default$onStatusChanged(LocationListenerCompat _this, String str, int i2, Bundle bundle) {
        }

        public static void $default$onLocationChanged(LocationListenerCompat _this, List list) {
            int size = list.size();
            for (int i2 = 0; i2 < size; i2++) {
                _this.onLocationChanged((Location) list.get(i2));
            }
        }
    }
}
