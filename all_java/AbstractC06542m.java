...
public abstract class AbstractC06542m<K, V> {

    /* JADX WARN: Incorrect inner types in field signature: Lcom/facebook/ads/redexgen/X/2m<TK;TV;>.EntrySet; */
    public C06502i A00;

    /* JADX WARN: Incorrect inner types in field signature: Lcom/facebook/ads/redexgen/X/2m<TK;TV;>.KeySet; */
    public C06512j A01;

    /* JADX WARN: Incorrect inner types in field signature: Lcom/facebook/ads/redexgen/X/2m<TK;TV;>.ValuesCollection; */
    public C06532l A02;
    ...
    public abstract V A0C(int i2, V v);
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.2m != com.facebook.ads.internal.androidx.support.v4.util.MapCollections<K, V> */
    public final Set<Map.Entry<K, V>> A08() {
        if (this.A00 == null) {
            this.A00 = new Set<Map.Entry<K, V>>() { // from class: com.facebook.ads.redexgen.X.2i
                ...
                /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.2i != com.facebook.ads.internal.androidx.support.v4.util.MapCollections<K, V>$EntrySet */
                @Override // java.util.Set, java.util.Collection
                ...
                public final boolean contains(Object obj) {
                    ...
                    return C06472f.A04(foundVal, entry.getValue());
                }
                ...
                public final boolean equals(Object obj) {
                    return AbstractC06542m.A03(this, obj);
                }
    ...
    public final Set<K> A09() {
        if (this.A01 == null) {
            this.A01 = new Set<K>() { // from class: com.facebook.ads.redexgen.X.2j
                /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.2j != com.facebook.ads.internal.androidx.support.v4.util.MapCollections<K, V>$KeySet */
                @Override // java.util.Set, java.util.Collection
                ...
                @Override // java.util.Set, java.util.Collection
                public final boolean containsAll(Collection<?> collection) {
                    return AbstractC06542m.A00(this.A00.A07(), collection);
                }
                ...
                public final int hashCode() {
                    ...
                    for (int i3 = result - 1; i3 >= 0; i3--) {
                        int i4 = 0;
                        Object objA0B = this.A00.A0B(i3, 0);
                        if (objA0B != null) {
                            i4 = objA0B.hashCode();
                        }
                        i2 += i4;
                ...
                @Override // java.util.Set, java.util.Collection
                public final boolean removeAll(Collection<?> collection) {
                    return AbstractC06542m.A01(this.A00.A07(), collection);
                }

                /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.2j != com.facebook.ads.internal.androidx.support.v4.util.MapCollections<K, V>$KeySet */
                @Override // java.util.Set, java.util.Collection
                public final boolean retainAll(Collection<?> collection) {
                    return AbstractC06542m.A02(this.A00.A07(), collection);
                }
    ...
    public final Collection<V> A0A() {
        if (this.A02 == null) {
            this.A02 = new Collection<V>() { // from class: com.facebook.ads.redexgen.X.2l
                ...
                public final boolean removeAll(Collection<?> collection) {
                    ...
                    int i2 = 0;
                    while (i2 < iA04) {
                        if (collection.contains(this.A00.A0B(i2, 1))) {
                            this.A00.A0E(i2);
                            i2--;
                            iA04--;
                            z = true;
                ...
                /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.2l != com.facebook.ads.internal.androidx.support.v4.util.MapCollections<K, V>$ValuesCollection */
                @Override // java.util.Collection
