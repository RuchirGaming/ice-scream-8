...
public class C3W {
    ...
    public boolean A07(ViewParent viewParent, View view, float f2, float f3) {
        if (viewParent instanceof AnonymousClass30) {
            return ((AnonymousClass30) viewParent).onNestedPreFling(view, f2, f3);
        }
        String[] strArr = A01;
    ...
    public boolean A08(ViewParent viewParent, View view, float f2, float f3, boolean z) {
        if (viewParent instanceof AnonymousClass30) {
            return ((AnonymousClass30) viewParent).onNestedFling(view, f2, f3, z);
        }
        return false;
    }
    ...
    public boolean A09(ViewParent viewParent, View view, View view2, int i2) {
        if (viewParent instanceof AnonymousClass30) {
            return ((AnonymousClass30) viewParent).onStartNestedScroll(view, view2, i2);
        }
        return false;
    }
}
