...
public final class C2V extends Drawable {
    ...
    public C2V(ColorStateList colorStateList, float f2) {
        this.A01 = f2;
        A01(colorStateList);
        this.A0A = new RectF();
        this.A09 = new Rect();
    ...
    private void A02(Rect rect) {
        ...
        this.A09.set(rect);
        if (this.A06) {
            float fA01 = C2X.A01(this.A00, this.A01, this.A07);
            float vInset = C2X.A00(this.A00, this.A01, this.A07);
