...
public final class zzfzf {
    ...
    public static long zzb(long j2, long j3) {
        zzfzg.zza("a", j2);
        zzfzg.zza(DownloadCommon.DOWNLOAD_REPORT_FIND_FILE_RESULT_VALUE_B, j3);
        if (j2 == 0) {
            return j3;
        }
        if (j3 == 0) {
    ...
    */
    public static long zza(long r8, long r10, java.math.RoundingMode r12) {
        ...
        L10:
            long r8 = r8 ^ r10
            int[] r6 = com.google.android.gms.internal.ads.zzfze.zza
            int r7 = r12.ordinal()
            r6 = r6[r7]
            r7 = 63
            long r8 = r8 >> r7
        ...
        L53:
            ...
            return r0
        L56:
            com.google.android.gms.internal.ads.zzfzg.zzb(r7)
        L59:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzfzf.zza(long, long, java.math.RoundingMode):long");
    }
}
