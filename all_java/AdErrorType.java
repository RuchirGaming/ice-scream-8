...
public enum AdErrorType {
    ...
    NO_AD_PLACEMENT(IronSourceConstants.RV_AUCTION_SUCCESS, A00(IronSourceError.ERROR_NT_LOAD_PLACEMENT_CAPPED, 42, 45), false),
    MEDIATION_ERROR(3001, A00(1926, 15, 30), true),
    BID_IMPRESSION_MISMATCH(IronSourceConstants.NT_LOAD, A00(465, 36, 10), true),
    BID_PAYLOAD_ERROR(IronSourceConstants.NT_INSTANCE_LOAD, A00(1673, 19, 67), false),
    NO_ADAPTER_ON_LOAD(IronSourceConstants.errorCode_biddingDataException, A00(292, 25, 116), false),
    NO_ADAPTER_ON_START(IronSourceConstants.errorCode_isReadyException, A00(317, 26, 15), false),
