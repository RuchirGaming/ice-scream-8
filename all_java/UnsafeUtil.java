...
final class UnsafeUtil {
    ...
    static void putBoolean(Object obj, long j2, boolean z) {
    ...
    private static int firstDifferingByteIndexNativeEndian(long j2, long j3) {
        ...
        if (IS_BIG_ENDIAN) {
            iNumberOfTrailingZeros = Long.numberOfLeadingZeros(j2 ^ j3);
        } else {
            iNumberOfTrailingZeros = Long.numberOfTrailingZeros(j2 ^ j3);
        }
