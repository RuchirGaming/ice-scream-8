...
public final class MenuItemCompat {
    ...
    static class Api26Impl {
        ...
        static MenuItem setShortcut(MenuItem menuItem, char c2, char c3, int i2, int i3) {
            return menuItem.setShortcut(c2, c3, i2, i3);
        }

        static MenuItem setNumericShortcut(MenuItem menuItem, char c2, int i2) {
        ...
        static MenuItem setAlphabeticShortcut(MenuItem menuItem, char c2, int i2) {
