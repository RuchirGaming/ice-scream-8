...
public interface ExoMediaDrm<T extends ExoMediaCrypto> {
    ...
    KeyRequest getKeyRequest(byte[] bArr, byte[] bArr2, String str, int i2, HashMap<String, String> map) throws NotProvisionedException;
    ...
    public static final class DefaultKeyStatus implements KeyStatus {
        ...
        DefaultKeyStatus(int i2, byte[] bArr) {
            this.statusCode = i2;
            this.keyId = bArr;
        }
