...
class FindAddress {
    ...
    private static class ZipRange {
        ...
        boolean matches(String str) {
            ...
            return (this.mLow <= i2 && i2 <= this.mHigh) || i2 == this.mException1 || i2 == this.mException2;
        }
    }
    ...
    private static boolean checkHouseNumber(String str) {
        ...
        int i5 = i4 % 10;
        if (i5 == 1) {
            return lowerCase.equals(i4 % 100 != 11 ? ApsMetricsDataMap.APSMETRICS_FIELD_STARTTIME : "th");
        }
        if (i5 == 2) {
    ...
    public static MatchResult matchHouseNumber(String str, int i2) {
        ...
        Matcher matcherRegion = sHouseNumberRe.matcher(str).region(i2, str.length());
    ...
    public static MatchResult matchState(String str, int i2) {
        ...
        Matcher matcherRegion = sStateRe.matcher(str).region(i2, str.length());
        if (matcherRegion.lookingAt()) {
            ...
            if (!matcher.find(iEnd)) {
                ...
                if (matchHouseNumber(str, iEnd) == null) {
                    if (!isValidLocationName(matcher.group(0))) {
                        ...
                        if (z && i4 > 4 && (matchResultMatchState = matchState(str, iEnd)) != null) {
