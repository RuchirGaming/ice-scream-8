...
public final class PermissionChecker {
    ...
    public static int checkPermission(Context context, String str, int i2, int i3, String str2) {
        ...
        if (Process.myUid() == i3 && ObjectsCompat.equals(context.getPackageName(), str2)) {
            iNoteProxyOpNoThrow = AppOpsManagerCompat.checkOrNoteProxyOp(context, i3, strPermissionToOp, str2);
        } else {
