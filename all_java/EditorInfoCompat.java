...
public final class EditorInfoCompat {
    ...
    private static void trimLongSurroundingText(EditorInfo editorInfo, CharSequence charSequence, int i2, int i3) {
        ...
        if (i5 != i4) {
            charSequenceSubSequence = TextUtils.concat(charSequence.subSequence(i7, i7 + iMin2), charSequence.subSequence(i3, iMin + i3));
        } else {
            charSequenceSubSequence = charSequence.subSequence(i7, i8 + i7);
        }
        int i9 = iMin2 + 0;
        setSurroundingText(editorInfo, charSequenceSubSequence, i9, i5 + i9);
    }
    ...
    public static CharSequence getInitialTextBeforeCursor(EditorInfo editorInfo, int i2, int i3) {
        ...
        if ((i3 & 1) != 0) {
            return charSequence.subSequence(i4 - iMin, i4);
        }
        return TextUtils.substring(charSequence, i4 - iMin, i4);
    }
