...
class FocusStrategy {
    ...
    public static <L, T> T findNextFocusInRelativeDirection(L l2, CollectionAdapter<L, T> collectionAdapter, BoundsAdapter<T> boundsAdapter, T t, int i2, boolean z, boolean z2) {
    ...
    public static <L, T> T findNextFocusInAbsoluteDirection(L l2, CollectionAdapter<L, T> collectionAdapter, BoundsAdapter<T> boundsAdapter, T t, Rect rect, int i2) {
