...
public final class zzap {
    public static int zza(int i2, int i3, String str) {
        ...
        if (i2 < 0) {
            strZza = zzaq.zza("%s (%s) must not be negative", FirebaseAnalytics.Param.INDEX, Integer.valueOf(i2));
        } else {
            if (i3 < 0) {
                throw new IllegalArgumentException("negative size: " + i3);
            }
            strZza = zzaq.zza("%s (%s) must be less than size (%s)", FirebaseAnalytics.Param.INDEX, Integer.valueOf(i2), Integer.valueOf(i3));
        }
    ...
    public static void zzd(boolean z, String str, char c2) {
        if (!z) {
            throw new IllegalArgumentException(zzaq.zza(str, Character.valueOf(c2)));
        }
    }
    ...
    public static void zze(int i2, int i3, int i4) {
        ...
        if (i2 < 0 || i3 < i2 || i3 > i4) {
            if (i2 < 0 || i2 > i4) {
                strZzf = zzf(i2, i4, "start index");
            } else {
                strZzf = (i3 < 0 || i3 > i4) ? zzf(i3, i4, "end index") : zzaq.zza("end index (%s) must not be less than start index (%s)", Integer.valueOf(i3), Integer.valueOf(i2));
            }
    ...
    private static String zzf(int i2, int i3, String str) {
        ...
        if (i3 >= 0) {
            return zzaq.zza("%s (%s) must not be greater than size (%s)", str, Integer.valueOf(i2), Integer.valueOf(i3));
        }
        throw new IllegalArgumentException("negative size: " + i3);
    }
}
