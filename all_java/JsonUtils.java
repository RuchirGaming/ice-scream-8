...
public class JsonUtils {
    ...
    public static Map<String, String> tryToStringMap(JSONObject jSONObject) {
        ...
        while (itKeys.hasNext()) {
            ...
            try {
                Object objAg = ag(jSONObject.get(next));
                map.put(next, objAg != null ? objAg.toString() : null);
    ...
    public static Map<String, String> toStringMap(JSONObject jSONObject) throws JSONException {
        ...
        while (itKeys.hasNext()) {
            String next = itKeys.next();
            map.put(next, ag(jSONObject.get(next)).toString());
        }
        return map;
    }
    ...
    public static Map<String, Object> toStringObjectMap(JSONObject jSONObject) throws JSONException {
        ...
        while (itKeys.hasNext()) {
            String next = itKeys.next();
            map.put(next, ag(jSONObject.get(next)));
        }
        return map;
    }
    ...
    public static Map<String, Object> toStringObjectMap(String str) {
        try {
            ...
            com.applovin.impl.sdk.x.f("JsonUtils", "Failed to convert json string '" + str + "' to map", e2);
            return new HashMap();
        }
    }
    ...
    private static <T> List<T> a(JSONArray jSONArray, List<T> list) throws JSONException {
        ...
        for (int i2 = 0; i2 < jSONArray.length(); i2++) {
            arrayList.add(ag(jSONArray.get(i2)));
        }
        return arrayList;
    }
    ...
    public static JSONObject jsonObjectFromJsonString(String str, JSONObject jSONObject) {
        try {
            ...
            com.applovin.impl.sdk.x.f("JsonUtils", "Failed to convert JSON string '" + str + "' to JSONObject", e2);
            return jSONObject;
        }
    }
    ...
    public static JSONArray deepCopy(JSONArray jSONArray) {
        ...
        for (int i2 = 0; i2 < jSONArray.length(); i2++) {
            try {
                ...
                com.applovin.impl.sdk.x.G("JsonUtils", "Failed to copy over item at index " + i2 + " to JSONArray deep copy");
            }
        }
        return jSONArray2;
    }
    ...
    public static void putObject(JSONObject jSONObject, String str, Object obj) {
        if (jSONObject != null) {
            try {
                ...
                com.applovin.impl.sdk.x.f("JsonUtils", "Failed to put Object property for key = " + str, e2);
            }
        }
    }
    ...
    public static void putString(JSONObject jSONObject, String str, String str2) {
        if (jSONObject != null) {
            try {
                ...
                com.applovin.impl.sdk.x.f("JsonUtils", "Failed to put String property for key = " + str, e2);
            }
        }
    }
    ...
    public static String getString(JSONObject jSONObject, String str, String str2) {
        ...
        try {
            ...
            com.applovin.impl.sdk.x.f("JsonUtils", "Failed to retrieve string property for key = " + str, e2);
            return str2;
        }
    }
    ...
    public static void putInt(JSONObject jSONObject, String str, int i2) {
        if (jSONObject != null) {
            try {
                ...
                com.applovin.impl.sdk.x.f("JsonUtils", "Failed to put int property for key = " + str, e2);
            }
        }
    }
    ...
    public static int getInt(JSONObject jSONObject, String str, int i2) {
        ...
        try {
            ...
            com.applovin.impl.sdk.x.f("JsonUtils", "Failed to retrieve int property for key = " + str, e2);
            return i2;
        }
    }
    ...
    public static long getLong(JSONObject jSONObject, String str, long j2) {
        ...
        try {
            ...
            com.applovin.impl.sdk.x.f("JsonUtils", "Failed to retrieve long property for key = " + str, e2);
            return j2;
        }
    }
    ...
    public static void putLong(JSONObject jSONObject, String str, long j2) {
        if (jSONObject != null) {
            try {
                ...
                com.applovin.impl.sdk.x.f("JsonUtils", "Failed to put long property for key = " + str, e2);
            }
        }
    }
    ...
    public static double getDouble(JSONObject jSONObject, String str, double d2) {
        ...
        try {
            ...
            com.applovin.impl.sdk.x.f("JsonUtils", "Failed to retrieve double property for key = " + str, e2);
            return d2;
        }
    }
    ...
    public static void putDouble(JSONObject jSONObject, String str, double d2) {
        if (jSONObject != null) {
            try {
                ...
                com.applovin.impl.sdk.x.f("JsonUtils", "Failed to put double property for key = " + str, e2);
            }
        }
    }
    ...
    public static void putBoolean(JSONObject jSONObject, String str, boolean z) {
        if (jSONObject != null) {
            try {
                ...
                com.applovin.impl.sdk.x.f("JsonUtils", "Failed to put boolean property for key = " + str, e2);
            }
        }
    }
    ...
    public static float getFloat(JSONObject jSONObject, String str, float f2) {
        ...
        try {
            ...
            com.applovin.impl.sdk.x.f("JsonUtils", "Failed to retrieve float property for key = " + str, e2);
            return f2;
        }
    }
    ...
    public static Object getObject(JSONObject jSONObject, String str, Object obj) {
        ...
        try {
            ...
            com.applovin.impl.sdk.x.f("JsonUtils", "Failed to retrieve Object for key = " + str, e2);
            return obj;
        }
    }
    ...
    public static void putJSONObject(JSONObject jSONObject, String str, JSONObject jSONObject2) {
        if (jSONObject != null) {
            try {
                ...
                com.applovin.impl.sdk.x.f("JsonUtils", "Failed to put JSON property for key = " + str, e2);
            }
        }
    }
    ...
    public static JSONObject getJSONObject(JSONObject jSONObject, String str, JSONObject jSONObject2) {
        ...
        try {
            ...
            com.applovin.impl.sdk.x.f("JsonUtils", "Failed to retrieve JSON property for key = " + str, e2);
            return jSONObject2;
        }
    }
    ...
    public static void putJsonArray(JSONObject jSONObject, String str, JSONArray jSONArray) {
        if (jSONObject != null) {
            try {
                ...
                com.applovin.impl.sdk.x.f("JsonUtils", "Failed to put JSONArray property for key = " + str, e2);
            }
        }
    }
    ...
    public static Object getObjectAtIndex(JSONArray jSONArray, int i2, Object obj) {
        ...
        try {
            ...
            com.applovin.impl.sdk.x.f("JsonUtils", "Failed to retrieve object at index " + i2 + " for JSON array", e2);
            return obj;
        }
    }
    ...
    public static JSONArray getJSONArray(JSONObject jSONObject, String str, JSONArray jSONArray) {
        ...
        try {
            ...
            com.applovin.impl.sdk.x.f("JsonUtils", "Failed to retrieve JSON array for key = " + str, e2);
            return jSONArray;
        }
    }
    ...
    public static JSONObject getJSONObject(JSONArray jSONArray, int i2, JSONObject jSONObject) {
        ...
        try {
            ...
            com.applovin.impl.sdk.x.f("JsonUtils", "Failed to retrieve JSON object from array for index = " + i2, e2);
            return jSONObject;
        }
    }
