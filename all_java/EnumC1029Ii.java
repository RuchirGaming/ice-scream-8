...
public enum EnumC1029Ii {
    ...
    A04(A01(790, 5, 30)),
    A0M(A01(617, 18, 15)),
    A05(A01(TTAdConstant.MATE_IS_NULL_CODE, 12, 106)),
    A07(A01(446, 11, 118)),
    A0T(A01(729, 15, 32)),
    A0U(A01(714, 15, 4)),
    A0R(A01(699, 11, 73)),
    ...
    EnumC1029Ii(String str) {
        this.A00 = str;
    }

    public static EnumC1029Ii A00(String str) {
        for (EnumC1029Ii enumC1029Ii : values()) {
            if (enumC1029Ii.A00.equalsIgnoreCase(str)) {
                return enumC1029Ii;
            }
        }
        String[] strArr = A02;
