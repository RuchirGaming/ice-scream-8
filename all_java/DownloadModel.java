...
public class DownloadModel {
    ...
    public void setUsageCounter(int i2) {
        this.usageCounter = i2;
    }
    ...
    public static DownloadModel create(String str, String str2, String str3, String str4, String str5, String str6, long j2, long j3, int i2, int i3, DownloadResourceType downloadResourceType) {
        ...
        downloadModel.setDownloadedBytes(j3);
        downloadModel.setTotalBytes(j2);
        downloadModel.setLastModifiedTime(System.currentTimeMillis());
        downloadModel.setUsageCounter(i3);
        downloadModel.setDownloadRate(i2);
    ...
    public void setUnZipResourceByte(long j2) {
        this.unZipResourceByte = j2;
    }
