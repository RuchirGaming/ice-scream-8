...
public final class zzcx {
    public static int zza(int i2, int i3, String str) {
        ...
        if (i2 < 0) {
            ...
            strZza = zzcy.zza("%s (%s) must be less than size (%s)", FirebaseAnalytics.Param.INDEX, Integer.valueOf(i2), Integer.valueOf(i3));
        }
    ...
    public static void zzc(int i2, int i3, int i4) {
        ...
        if (i2 < 0 || i3 < i2 || i3 > i4) {
            if (i2 < 0 || i2 > i4) {
                strZzd = zzd(i2, i4, "start index");
            } else {
                strZzd = (i3 < 0 || i3 > i4) ? zzd(i3, i4, "end index") : zzcy.zza("end index (%s) must not be less than start index (%s)", Integer.valueOf(i3), Integer.valueOf(i2));
            }
    ...
    private static String zzd(int i2, int i3, String str) {
        ...
        if (i3 >= 0) {
            return zzcy.zza("%s (%s) must not be greater than size (%s)", str, Integer.valueOf(i2), Integer.valueOf(i3));
        }
        throw new IllegalArgumentException("negative size: " + i3);
    }
}
