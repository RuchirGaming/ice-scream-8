...
public final class C$Gson$Types {
    ...
    /* JADX WARN: Code duplicated, block: B:51:0x00c6 A[EDGE_INSN: B:51:0x00c6->B:59:0x00dc BREAK  A[LOOP:0: B:3:0x0001->B:69:?]] */
    /* JADX WARN: Code duplicated, block: B:52:0x00cb  */
    /* JADX WARN: Code duplicated, block: B:54:0x00ce  */
    /* JADX WARN: Code duplicated, block: B:58:0x00d8 A[EDGE_INSN: B:58:0x00d8->B:59:0x00dc BREAK  A[LOOP:0: B:3:0x0001->B:69:?]] */
    /* JADX WARN: Code duplicated, block: B:72:0x009d A[SYNTHETIC] */
                ...
                if (!(type2 instanceof Class)) {
                    ...
                    if (type2 instanceof ParameterizedType) {
                        ...
                        for (i2 = 0; i2 < length; i2++) {
                            typeResolve4 = resolve(type, cls, actualTypeArguments[i2], map);
                            if (equal(typeResolve4, actualTypeArguments[i2])) {
                                if (!z) {
