...
public enum EnumC1188Oq {
    ...
    A0P(A01(482, 12, 102)),
    A0L(A01(446, 11, 11)),
    A0B(A01(DtbConstants.DEFAULT_PLAYER_WIDTH, 11, 93)),
    A08(A01(428, 18, 20)),
    A0I(A01(398, 9, 16)),
    A0O(A01(0, 0, 107));
    ...
    EnumC1188Oq(String str) {
        this.A00 = str;
    }

    public static EnumC1188Oq A00(String str) {
        for (EnumC1188Oq enumC1188Oq : values()) {
            if (enumC1188Oq.A00.equalsIgnoreCase(str)) {
                return enumC1188Oq;
            }
        }
        return A0O;
