...
public final class AdvancedTlsX509TrustManager extends X509ExtendedTrustManager {
    ...
    private static X509ExtendedTrustManager createDelegateTrustManager(KeyStore keyStore) throws NoSuchAlgorithmException, KeyStoreException, CertificateException {
        ...
        while (true) {
            ...
            if (trustManagers[i2] instanceof X509ExtendedTrustManager) {
                x509ExtendedTrustManager = (X509ExtendedTrustManager) trustManagers[i2];
                break;
            }
            i2++;
        }
    ...
    public Closeable updateTrustCredentialsFromFile(File file, long j2, TimeUnit timeUnit, ScheduledExecutorService scheduledExecutorService) throws GeneralSecurityException, IOException {
        ...
        final ScheduledFuture<?> scheduledFutureScheduleWithFixedDelay = scheduledExecutorService.scheduleWithFixedDelay(new LoadFilePathExecution(file), j2, j2, timeUnit);
    ...
    public long readAndUpdate(File file, long j2) throws GeneralSecurityException, IOException {
