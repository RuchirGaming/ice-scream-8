...
final class WeightTypefaceApi21 {
    ...
    static Typeface createWeightStyle(Typeface typeface, int i2, boolean z) {
        ...
        synchronized (sWeightCacheLock) {
            ...
            if (sparseArray == null) {
                ...
                Typeface typeface2 = sparseArray.get(i3 == true ? 1 : 0);
                if (typeface2 != null) {
                    return typeface2;
                }
            }
            if (z == typeface.isItalic()) {
                ...
                typefaceCreate = create(nativeCreateFromTypefaceWithExactStyle(nativeInstance, i2, z));
            }
            sparseArray.put(i3 == true ? 1 : 0, typefaceCreate);
    ...
    private static long nativeCreateFromTypefaceWithExactStyle(long j2, int i2, boolean z) {
        try {
            return ((Long) sNativeCreateWeightAlias.invoke(null, Long.valueOf(((Long) sNativeCreateFromTypeface.invoke(null, Long.valueOf(j2), Integer.valueOf(z ? 2 : 0))).longValue()), Integer.valueOf(i2))).longValue();
        } catch (IllegalAccessException e2) {
            throw new RuntimeException(e2);
