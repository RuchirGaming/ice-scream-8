    ...
    public E removeAt(int i2) {
        ...
        if (i3 <= 1) {
            ...
            if (iArr.length > 8 && i3 < iArr.length / 3) {
                ...
                if (i2 < i4) {
                    int i5 = i2 + 1;
                    System.arraycopy(iArr, i5, this.mHashes, i2, i4 - i2);
                    System.arraycopy(objArr, i5, this.mArray, i2, this.mSize - i2);
                }
            } else {
                int i6 = i3 - 1;
                this.mSize = i6;
                if (i2 < i6) {
                    ...
                    Object[] objArr2 = this.mArray;
                    System.arraycopy(objArr2, i7, objArr2, i2, this.mSize - i2);
                }
