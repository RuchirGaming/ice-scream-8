...
public class ActivityOptionsCompat {
    ...
    static class Api16Impl {
        ...
        static ActivityOptions makeCustomAnimation(Context context, int i2, int i3) {
            return ActivityOptions.makeCustomAnimation(context, i2, i3);
        }

        static ActivityOptions makeScaleUpAnimation(View view, int i2, int i3, int i4, int i5) {
            return ActivityOptions.makeScaleUpAnimation(view, i2, i3, i4, i5);
        }

        static ActivityOptions makeThumbnailScaleUpAnimation(View view, Bitmap bitmap, int i2, int i3) {
