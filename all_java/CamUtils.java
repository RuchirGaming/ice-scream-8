...
final class CamUtils {
    ...
    static float lStarFromInt(int i2) {
    ...
    static float yFromInt(int i2) {
        ...
        return (fLinearized * fArr[1][0]) + (fLinearized2 * fArr[1][1]) + (fLinearized3 * fArr[1][2]);
    }

    static float[] xyzFromInt(int i2) {
        float fLinearized = linearized(Color.red(i2));
        float fLinearized2 = linearized(Color.green(i2));
        float fLinearized3 = linearized(Color.blue(i2));
        float[][] fArr = SRGB_TO_XYZ;
        return new float[]{(fArr[0][0] * fLinearized) + (fArr[0][1] * fLinearized2) + (fArr[0][2] * fLinearized3), (fArr[1][0] * fLinearized) + (fArr[1][1] * fLinearized2) + (fArr[1][2] * fLinearized3), (fLinearized * fArr[2][0]) + (fLinearized2 * fArr[2][1]) + (fLinearized3 * fArr[2][2])};
    }
    ...
    static float linearized(int i2) {
        float f2 = i2 / 255.0f;
