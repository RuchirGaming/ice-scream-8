...
public final class AT extends Exception {
    ...
    public AT(int i2, int i3, int i4, int i5) {
        StringBuilder sbAppend = new StringBuilder().append(A00(12, 24, 46)).append(i2).append(A00(3, 9, 17)).append(i3);
        String strA00 = A00(1, 2, 68);
        super(sbAppend.append(strA00).append(i4).append(strA00).append(i5).append(A00(0, 1, 29)).toString());
        this.A00 = i2;
    }
}
