...
public final class C07667g {
    ...
    public C07667g(Set<String> options, Integer num, Integer num2, String str) {
        this.A03 = options;
        options.remove(null);
        this.A00 = num;
        this.A01 = num2;
    ...
    public C07667g(String[] strArr, Integer num, Integer num2) {
    ...
    public static C07667g A00(String str) {
        if (str == null) {
            return null;
        }
        LinkedHashSet linkedHashSet = new LinkedHashSet();
        ...
        return new C07667g(linkedHashSet, numValueOf, numValueOf2, str);
    }
    ...
    public final boolean equals(Object obj) {
        if (!(obj instanceof C07667g)) {
            return false;
        }
        C07667g c07667g = (C07667g) obj;
        ...
        A06[0] = "YHhc40Na8nm";
        Integer num2 = c07667g.A00;
        if (num != num2 && (num == null || !num.equals(num2))) {
            return false;
        }
        Integer num3 = this.A01;
        Integer num4 = c07667g.A01;
        return (num3 == num4 || (num3 != null && num3.equals(num4))) && this.A03.equals(c07667g.A03);
    }
