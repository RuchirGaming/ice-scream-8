    ...
    private void changeSpeed(float f2) {
        ...
        do {
            if (this.remainingInputToCopyFrameCount > 0) {
                iInsertPitchPeriod = copyInputToOutput(i3);
            } else {
                int iFindPitchPeriod = findPitchPeriod(this.inputBuffer, i3);
                if (f2 > 1.0d) {
                    iInsertPitchPeriod = iFindPitchPeriod + skipPitchPeriod(this.inputBuffer, i3, f2, iFindPitchPeriod);
                } else {
                    iInsertPitchPeriod = insertPitchPeriod(this.inputBuffer, i3, f2, iFindPitchPeriod);
                }
            }
            i3 += iInsertPitchPeriod;
