...
public class C06893x {
    ...
    public C06893x(int i2, int i3, int i4, Object obj) {
        this.A00 = i2;
        this.A02 = i3;
        this.A01 = i4;
        this.A03 = obj;
    ...
    public final boolean equals(Object obj) {
        ...
        C06893x c06893x = (C06893x) obj;
        int i2 = this.A00;
        if (i2 != c06893x.A00) {
            return false;
        }
        if (i2 == 8 && Math.abs(this.A01 - this.A02) == 1 && this.A01 == c06893x.A02 && this.A02 == c06893x.A01) {
            return true;
        }
        if (this.A01 != c06893x.A01 || this.A02 != c06893x.A02) {
            return false;
        }
        Object obj2 = this.A03;
        if (obj2 != null) {
            if (!obj2.equals(c06893x.A03)) {
                return false;
            }
        } else {
            Object obj3 = c06893x.A03;
            if (A05[2].charAt(7) == 'q') {
                throw new RuntimeException();
            }
