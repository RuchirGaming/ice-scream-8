...
import com.facebook.ads.redexgen.X.C06030n;
import java.lang.ref.WeakReference;
import java.util.Arrays;
import java.util.HashMap;

/* JADX INFO: renamed from: com.facebook.ads.redexgen.X.0n, reason: invalid class name and case insensitive filesystem */
/* JADX INFO: loaded from: /workspaces/ice-scream-8/./apk_dex_files/audience_network.dex */
public final class C06030n {
    ...
    public final InterfaceC1026If A05;
    public long A00 = 0;
    public String A04 = null;
    public EnumC05960f A02 = null;
    ...
    public C06030n(InterfaceC1026If interfaceC1026If, final Activity activity, int i2) {
        this.A05 = interfaceC1026If;
    ...
    public static C06030n A00(InterfaceC1026If interfaceC1026If, Activity activity) {
        return A01(interfaceC1026If, activity, Build.VERSION.SDK_INT);
    }

    public static C06030n A01(InterfaceC1026If interfaceC1026If, Activity activity, int i2) {
        if (activity != null && i2 >= 14) {
            return new C06030n(interfaceC1026If, activity, i2);
        }
        return null;
    }

    private void A04(String str, long j2, long j3, EnumC05960f enumC05960f) {
        HashMap map = new HashMap();
        map.put(A02(9, 10, 8), Long.toString(j2));
        map.put(A02(0, 9, 34), Long.toString(j3));
        if (enumC05960f != null) {
            map.put(A02(19, 7, 9), enumC05960f.name());
        }
    ...
    public final void A06(EnumC05960f enumC05960f) {
        this.A02 = enumC05960f;
    }
    ...
    public final void A07(String str) {
        ...
        EnumC05960f enumC05960f = EnumC05960f.A03;
        if (A07[2].charAt(6) == '9') {
